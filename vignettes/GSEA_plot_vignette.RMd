...
The enrichment score ouput allows you to access the data used to generate the plots so that you might create your own.
```{r }
data1=pp$ES[[2]]
head(data1)
```
...
This package introduces the ability to create your own databases or combine two. When using a combined dataabse, you have the ability to compare enrichment scores between genesets from different databases. 
...
enrichment_TF= GSEAplots(input.ds.name=expr.input,
               input.cls.name=pheno.input, gene.set.input=gene.set.input,
               doc.string="Aagmex_TF", nperm=1000,nom.p.val.threshold=-1,fdr.q.val.threshold = 0.25,
               bar_percent=0.1, gap_percent=0.1, under_percent=0.1,upper_percent=0.1,color_line="black",
               color_tick="black",abs.val=F)
```
