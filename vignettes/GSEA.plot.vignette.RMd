...
```{r results="hide",warning=FALSE}
 pp= GSEAplots(input.ds.name=expr.input,
               ...
               doc.string="Aagmex_hall", nperm=1000,nom.p.val.threshold=-1,
...
This package introduces the ability to create your own database.  
...
hall_13_results= GSEAplots(input.ds.name=expr.input,
               input.cls.name=pheno.input, gene.set.input=gene.set.input,
               doc.string="Aagmex_hall13", nperm=1000,nom.p.val.threshold=-1,
